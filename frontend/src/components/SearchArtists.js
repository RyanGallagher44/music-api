      ...
      <form>
        ...
        <div class="relative">
          ...
          <button
            ...
            class="text-spotify-black absolute end-2.5 bottom-2.5 dark:bg-spotify-green hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-spotify-green dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Search
          </button>
        </div>
